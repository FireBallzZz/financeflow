...
>(({ className, children, ...props }, ref) => (
  <DialogPrimitive.Portal>
    ...
    >
      {children}
      <DialogPrimitive.Close className="absolute right-4 top-4 rounded-lg p-1 opacity-70 transition-opacity hover:opacity-100 hover:bg-muted focus:outline-none">
        <X className="h-4 w-4" />
